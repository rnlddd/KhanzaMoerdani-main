...
public final class RMPenilaianAwalKeperawatanRanapNeonatus extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-05-2024 17:23:03" }));
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-05-2024" }));
    ...
    public void setNoRm(String norwt,Date tgl2) {
        ...
        isRawat(); 
         ...
         //   Tatalaksana.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            FisikSuhu.setText(Sequel.cariIsi("select suhu_tubuh from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            FisikTD.setText(Sequel.cariIsi("select tensi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            FisikBB.setText(Sequel.cariIsi("select berat from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            FisikTB.setText(Sequel.cariIsi("select tinggi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            FisikHR.setText(Sequel.cariIsi("select nadi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            FisikRR.setText(Sequel.cariIsi("select respirasi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            FisikGCS.setText(Sequel.cariIsi("select gcs from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
           FisikSPO.setText(Sequel.cariIsi("select SpO2 from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
        }else{
